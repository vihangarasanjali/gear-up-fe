        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/services" className="text-ternary hover:text-white transition-colors">Services</Link></li>
              <li><Link href="/contact" className="text-ternary hover:text-white transition-colors">Contact Us</Link></li>
